...
def generate_tiled_map_json():
    # Definir as dimensões do mapa (exemplo, pode ser ajustado)
    map_width = 50
    map_height = 50
    tile_size = 32 # pixels
    ...
    # Alas Laterais - Operações
    object_layer["objects"].append({"id": 6, "name": "Sala Marketing", "point": True, "x": (map_width * 3/4) * tile_size, "y": (map_height/4) * tile_size, "type": "area"})
    object_layer["objects"].append({"id": 7, "name": "Marketing Board", "point": True, "x": (map_width * 3/4 - 2) * tile_size, "y": (map_height/4 + 2) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "ar_online_marketing_board.png"}, {"name": "openWebsite", "type": "string", "value": "https://marketing.ar-online.com/dashboard"}]})
    object_layer["objects"].append({"id": 12, "name": "Sales Dashboard", "point": True, "x": (map_width * 3/4 + 2) * tile_size, "y": (map_height/4 + 5) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "ar_online_sales_dashboard.png"}, {"name": "openWebsite", "type": "string", "value": "https://crm.ar-online.com/dashboard"}]})
    object_layer["objects"].append({"id": 13, "name": "Dev Monitors", "point": True, "x": (map_width * 3/4 - 5) * tile_size, "y": (map_height/4 + 5) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "ar_online_dev_monitors.png"}, {"name": "openWebsite", "type": "string", "value": "https://github.com/ar-online-dev"}]})
    object_layer["objects"].append({"id": 14, "name": "Support Dashboard", "point": True, "x": (map_width * 3/4 - 5) * tile_size, "y": (map_height/4 + 8) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "ar_online_support_dashboard.png"}, {"name": "openWebsite", "type": "string", "value": "https://support.ar-online.com/dashboard"}]})

    # Área de Convivência e Eventos
    object_layer["objects"].append({"id": 8, "name": "Jardim Virtual", "point": True, "x": map_width/2 * tile_size, "y": (map_height/4 - 5) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "ar_online_virtual_garden.png"}, {"name": "openWebsite", "type": "string", "value": "https://ar-online.com/sustentabilidade"}]})
    object_layer["objects"].append({"id": 15, "name": "Auditorio", "point": True, "x": (map_width/2 - 5) * tile_size, "y": (map_height/4 - 10) * tile_size, "type": "area"})
    object_layer["objects"].append({"id": 16, "name": "Lounge Sofa", "point": True, "x": (map_width/2 + 5) * tile_size, "y": (map_height/4 - 10) * tile_size, "type": "image", "properties": [{"name": "image", "type": "string", "value": "WA_Seats.png"}, {"name": "openWebsite", "type": "string", "value": "https://ar-online.com/playlist-lounge"}]})
    ...
    with open("work_adventure_map.json", "w") as f:
